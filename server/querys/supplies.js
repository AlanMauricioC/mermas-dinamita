...
function insertSupply(req, res) {
    con.query("INSERT INTO supplies (idUnit, idUser, maxQuantitySupply, minQuantitySupply, nameSupply, statusSupply,quantitySupply) VALUES (?, ?, ?, ?, ?, ?, ?)", [req.body.idUnit, req.body.idUser, req.body.max, req.body.min, req.body.name, 1, req.body.quantity], function (err, result, fields) {
        if (err) throw err;
